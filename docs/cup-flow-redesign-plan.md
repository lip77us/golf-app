...
|---|---|---|---|
| 1 | `cup-wizard-step1` | Type & format as the **first** step; scoring-unit pills (side/golfer/pair/group); consequence strip; **derived step-plan panel** driving an honest "1 of N" | promote the Team-Cup championship chip (`_Step0Tournament` L1293–1310) to a first-class type+format picker; feed `_isCupTournament`/`_totalSteps` (L65–71) |
