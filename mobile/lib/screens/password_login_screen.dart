/// screens/password_login_screen.dart
/// Legacy account-name + username + password login.
///
/// Phone/OTP is now the primary sign-in path (see [LoginScreen] /
/// phone_login). This form is kept reachable from a "use a username instead"
/// link so existing accounts and the App Store demo/reviewer login keep
/// working unchanged.
...
class _PasswordLoginScreenState extends State<PasswordLoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Sign in with a username')),
      body: SafeArea(
        child: Center(
