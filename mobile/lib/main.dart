...
import 'screens/banker_settlement_screen.dart';
import 'screens/banker_setup_screen.dart';
import 'screens/banker_screen.dart';
import 'screens/sequoya_threes_setup_screen.dart';
import 'screens/sequoya_threes_screen.dart';
import 'screens/sequoya_threes_settlement_screen.dart';
...
import 'screens/triple_nassau_screen.dart';
    ...
    switch (settings.name) {
      ...
      case '/triple-nassau-setup':
        return page((_) => TripleNassauSetupScreen(
              ...
              returnToHub: _routeReturnToHub(settings.arguments)));
      case '/triple-nassau':
        return page((_) => TripleNassauScreen(
              foursomeId: settings.arguments as int));
      case '/vegas-setup':
      ...
      case '/banker-setup':
        return page((_) => BankerSetupScreen(
              foursomeId: _routeId(settings.arguments),
              returnToHub: _routeReturnToHub(settings.arguments)));
      case '/banker':
        final foursomeId = settings.arguments as int;
        return page((_) => RoundLandscapeScorecard(
              foursomeId: foursomeId,
              child: BankerScreen(foursomeId: foursomeId)));
      case '/banker-settlement':
        return page((_) => BankerSettlementScreen(
              foursomeId: _routeId(settings.arguments)));
      ...
      case '/sequoya-threes-settlement':
        return page((_) => SequoyaThreesSettlementScreen(
              foursomeId: _routeId(settings.arguments)));
      case '/survivor-setup':
      ...
      case '/survivor':
        ...
        return page((_) => RoundLandscapeScorecard(
              foursomeId: foursomeId,
              child: SurvivorScreen(foursomeId: foursomeId)));
