...
urlpatterns = [
    ...
    path('foursomes/<int:pk>/team-play/team/',    views.TeamPlayTeamView.as_view(),  name='api-team-play-team'),
    path('foursomes/<int:pk>/team-play/drive/',   views.TeamPlayDriveView.as_view(), name='api-team-play-drive'),
    path('foursomes/<int:pk>/team-play/split/',   views.TeamPlaySplitView.as_view(), name='api-team-play-split'),
    path('foursomes/<int:pk>/team-play/pairs/',   views.TeamPlayPairsView.as_view(), name='api-team-play-pairs'),
    path('foursomes/<int:pk>/team-play/score/',   views.TeamPlayScoreView.as_view(), name='api-team-play-score'),
    path('foursomes/<int:pk>/team-play/card/',    views.TeamPlayCardView.as_view(),  name='api-team-play-card'),
    path('tournaments/<int:pk>/team-play/leaderboard/', views.TeamPlayLeaderboardView.as_view(), name='api-team-play-leaderboard'),
    path('tournaments/<int:pk>/team-play/settlement/',  views.TeamPlaySettlementView.as_view(),  name='api-team-play-settlement'),
    path('tournaments/<int:pk>/mini-singles/',            views.MiniSinglesView.as_view(),      name='api-mini-singles'),
    path('tournaments/<int:pk>/mini-singles/setup/',      views.MiniSinglesSetupView.as_view(), name='api-mini-singles-setup'),
    path('tournaments/<int:pk>/mini-singles/sync-day2/',  views.MiniSinglesSyncView.as_view(),  name='api-mini-singles-sync'),
    ...
    path('rounds/<int:pk>/day-bet/',       views.DayBetView.as_view(),      name='api-day-bet'),
